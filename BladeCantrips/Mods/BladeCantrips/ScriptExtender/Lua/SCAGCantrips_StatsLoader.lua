function SCAGCantrips_StatsLoaded()
    ...
    eleAffinity.Boosts = "IF(IsSpell() and IsDamageTypeFire() and not WeaponAttackSpell()):DamageBonus(max(0, CharismaModifier));IF(IsDamageTypeFire() and WeaponAttackSpell()):CharacterWeaponDamage(max(0, CharismaModifier),Fire)"
